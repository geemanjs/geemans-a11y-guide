...
const Selects = () => (
  <div>
    ...
    <h3>Essentials</h3>
    <ul>
      <li>Use the browsers own <code>&lt;select&gt;</code> over any third party</li>
      <li>When a more than 10 options are present consider <code>&lt;optgroup&gt;</code> as a means to group related
        options. This will allow users to skip over unnecessary options when search for the one they wish to select.
      </li>
      <li>If you have less than 5 options consider <code>radio</code>s instead</li>
    </ul>
    <h4>More info</h4>
    <ul>
    ...
    <section className="section-with-aside">
      <Example>
        ...
        <CodeExample header="HTML" syntax="html">{
          `&lt;label htmlFor="cheese_selector"&gt;Select Cheese&lt;/label&gt;
&lt;select&gt;
  &lt;option value="Select"&gt;Select cheese&lt;/option&gt;
  &lt;optgroup label="Hard"&gt;
    &lt;option value="CHEDDAR"&gt;Cheddar&lt;/option&gt;
...
&lt;/select&gt;`
        ...
        <CodeExample header="CSS" syntax="css">
          {`select {
  appearance: none; // This is enables you to style
  padding: 10px;
  background: no-repeat #ffffff;
  //  You can use your own image url here if you so wish..
  background-image: url(data:image/png;base64,);
  background-position:  right;
}`}
        </CodeExample>
